...
function scene:create( event )
	...
	if language=="English" then
		story = display.newImageRect( sceneGroup, "backgrounds/paczelExplanationEnglish.png", 1000,800 )
	elseif language=="Japanese" then
		story = display.newImageRect( sceneGroup, "backgrounds/paczelExplanationJapanese.png", 1000,800 )
	elseif language=="Spanish" then
		story = display.newImageRect( sceneGroup, "backgrounds/paczelExplanationSpanish.png", 1000,800 )
	elseif language=="Romaji" then
		story = display.newImageRect( sceneGroup, "backgrounds/paczelExplanationRomaji.png", 1000,800 )
	end
	...
	highScoresButton:addEventListener( "tap", gotoPaczel )
