...
function scene:create( event )
	...
	story = display.newImageRect( sceneGroup, "backgrounds/GoodJob.png", 1000,800 )
	...
	local wordsRight = composer.getVariable( "wordsRight" )
	local highScoresButton = display.newText( sceneGroup, tostring(wordsRight).."/"..8, display.contentCenterX, 650, "fonts/ume-tgc5.ttf", 60 )
	highScoresButton:setFillColor( 0, 1, 0 )
