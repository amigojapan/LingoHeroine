...
function scene:create( event )
	...
	if language=="English" then
		story = display.newImageRect( sceneGroup, "backgrounds/quizExplanationEnglish.png", 1000,800 )
	elseif language=="Japanese" then
		story = display.newImageRect( sceneGroup, "backgrounds/quizExplanationJapanese.png", 1000,800 )
	elseif language=="Spanish" then
		story = display.newImageRect( sceneGroup, "backgrounds/quizExplanationSpanish.png", 1000,800 )
	elseif language=="Romaji" then
		story = display.newImageRect( sceneGroup, "backgrounds/quizExplanationRomaji.png", 1000,800 )
	end
